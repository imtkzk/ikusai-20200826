<template>
    <div>
        <Header />
        <div class="container">
            <section class="sec sec--thanks">
              <div>
                <div class="sec__in">
                  <h2 class="thanks-sec-head">ディープラーニング<br class="br--sp">ハンズオンコースの<br>購入が完了しました！</h2>
                  <div class="thanks-btn">
                    <BackBtn>ikus.ai トップページへ</BackBtn>
                  </div>
                </div>
              </div>
            </section>
...
<script>
    ...
    import BackBtn from '~/components/atoms/buttons/BackBtn.vue'
